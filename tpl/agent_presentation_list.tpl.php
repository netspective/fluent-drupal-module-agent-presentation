...
<table id="device_list">
  ...
  <tbody>
    ...
    <tr id="device-list">
      <td><?php echo $device['name_text']; ?></td>
      <td><?php echo $device['sub_text']; ?></td>
      <td><div id="<?php echo $device['sub_text']; ?>" class="action_text"></div></td>
      <td><input type="hidden" value="<?php print $device['name_text'];?>" id="<?php echo $device['sub_text']; ?>_value" /></td>
	</tr>  
    <?php endforeach; ?>
  </tbody>
</table>
